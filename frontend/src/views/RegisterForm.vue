...
<template>
  <div class="flex h-screen items-center justify-center" style="max-height:-webkit-fill-available;">
    <div class="flex flex-col gap-2 items-center justify-center w-full max-w-[480px] bg-[var(--color-sumato-surface)] p-6 rounded-xl shadow">
      ...
      <form @submit.prevent="onSubmit" class="w-full space-y-5 mt-4">
        ...
        <p v-if="errors.general" class="text-[var(--color-sumato-danger)] text-sm  flex justify-centertext-center mt-2">
          {{ errors.general }}
        </p>
