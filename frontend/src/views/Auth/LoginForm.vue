...
<template>
  <div class="flex h-screen items-center justify-center" style="max-height: -webkit-fill-available">
    <div
      class="flex flex-col gap-2 items-center justify-center w-full max-w-[480px] p-6 rounded-xl shadow"
    >
      <img :src="Logo" alt="Logo" class="img_light" />
      <img :src="LogoDark" alt="Logo" class="img_dark" />

      <form @submit.prevent="onSubmit" class="w-full space-y-5 mt-4" autocomplete="on">
