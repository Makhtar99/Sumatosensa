...
<template>
  ...
  >
    ...
    <button
      ...
      class="absolute top-4 !border-none right-2 w-8 h-8 rounded-full bg-sumato-primary text-white flex items-center justify-center hover:bg-sumato-primary-hover transition"
    >
    ...
    <nav class="flex-1 w-full px-4 space-y-2">
      ...
      <SidebarItem v-if="isAdmin" :icon="Export" label="Gestion" to="/management" />
    </nav>
